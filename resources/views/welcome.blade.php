    ...
    @if (file_exists(public_path('build/manifest.json')) || file_exists(public_path('hot')))
        <script>
            window.reverbConfig = {
                ...
                wsHost: '{{ env("VITE_REVERB_HOST", config("broadcasting.connections.reverb.options.host", "localhost")) }}',
                wsPort: +'{{ env("VITE_REVERB_PORT", config("broadcasting.connections.reverb.options.port", 80)) }}',
                wssPort: +'{{ env("VITE_REVERB_PORT", config("broadcasting.connections.reverb.options.port", 443)) }}',
                scheme: '{{ env("VITE_REVERB_SCHEME", config("broadcasting.connections.reverb.options.scheme", "https")) }}'
            };
        </script>
